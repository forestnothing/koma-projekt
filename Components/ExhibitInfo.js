...
const ExhibitInfo = ({ route }) => {
    ...
    function getExhibitById(id) {
        var exhibitMatch = events.find(exhibit => exhibit.id == id);
        return exhibitMatch;
    }
        ...
        <View style={styles.container}>
            <ScrollView style={styles.scroll}>
                <View style={styles.subview}>
                    <ImageBackground source={exhibit.img} style={{ width: '100%', height: '40%', resizeMode: "cover", justifyContent: 'flex-end' }} />
